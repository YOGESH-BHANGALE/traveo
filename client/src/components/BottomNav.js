...
import { FiHome, FiPlusCircle, FiNavigation, FiCompass, FiUser } from 'react-icons/fi';
...
export default function BottomNav() {
  ...
  // Drivers have their own DriverBottomNav — don't show rider nav to them
  // Also don't show while loading to prevent flash of wrong nav
  ...
  return (
    ...
    >
      {/* Solid bg — backdrop-blur is GPU-expensive on mobile */}
